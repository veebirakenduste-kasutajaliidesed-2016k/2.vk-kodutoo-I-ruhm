	...
	scam.prototype = {
		...
		this.noobs.forEach(function (item, j){
			 ...
			 if(item.data_id == target_id){
				...
				console.log("aylmaoss")
				console.log("saveData.php?name="+scam.instance.noobs[j].name+"&surname="+scam.instance.noobs[j].surname+"&age="+scam.instance.noobs[j].age+"&address="+scam.instance.noobs[j].address+"&creditcard="+scam.instance.noobs[j].creditcard+"&security="+scam.instance.noobs[j].security+"&data_id="+scam.instance.noobs[j].data_id);
				xhttp.open("GET", "saveData.php?name="+scam.instance.noobs[j].name+"&surname="+scam.instance.noobs[j].surname+"&age="+scam.instance.noobs[j].age+"&address="+scam.instance.noobs[j].address+"&creditcard="+scam.instance.noobs[j].creditcard+"&security="+scam.instance.noobs[j].security+"&data_id="+scam.instance.noobs[j].data_id+"&del=1", true);
							//päringu tegemine
				xhttp.send();
			 }else{
				 console.log("aylmao");
